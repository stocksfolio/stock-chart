      ...
      <div id={'stock-chart-container'}>
              ...
              <div className="sc-icon">
                <svg width="12" height="14" viewBox="0 0 12 14">
                  <g fillRule="evenodd">
                    ...
                    <path d="M4.224,8.4 L7.776,8.4 L7.776,8.4 C10.1088508,8.4 12,10.2911492 12,12.624 L12,14 L0,14 L0,12.624 L8.8817842e-16,12.624 C6.02486595e-16,10.2911492 1.89114922,8.4 4.224,8.4 Z"></path>
                  </g>
                </svg>
              </div>
        ...
        <div id={'stock-chart-company-info-container'}>
          ...
          <div id={'stock-chart-percent-change'}>
            +US$1.43 (0.32%) <span className="sc-percent">Today</span>
          </div>
          <div id={'stock-chart-percent-change'}>
          +US$1.23 (0.52%) <span className="sc-percent">After Hours</span>
          </div>
        </div>
        <div id={'stock-chart-stock-info-container'}>
        </div>
